              ...
              {Object.keys(values).filter(key=>{
                ...
                return (
                  values[feedbackKey].feedback.length > 0 && (
                    <div
                      key={key}
                      className={`flex flex-col gap-[5px] p-2 rounded-[5px]
        ${
          values[feedbackKey].point >= 6
            ? "bg-[#268a26]"
            : values[feedbackKey].point >= 3
            ? "bg-[#a2a21b]"
            : "bg-[#E23636]"
        }
      `}
                    >
                      <h1 className="text-[#FFF] font-bold sm:text-[20px] text-[16px]">
                        {key}
                      </h1>
                      <p className="text-[#FFF] sm:text-[16px] text-[14px]">
                        {" "}
                        {values[feedbackKey].feedback}
                      </p>
                    </div>
                  )
                );
